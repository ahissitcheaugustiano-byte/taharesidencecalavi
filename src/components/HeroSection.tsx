...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="relative z-10 text-center px-4 sm:px-6 w-full max-w-5xl mx-auto pt-20"
      ...
      >
        <motion.span 
          ...
          className="inline-block px-4 py-1.5 mb-6 rounded-full border border-primary/30 bg-primary/10 backdrop-blur-sm text-primary text-[10px] sm:text-xs font-bold uppercase tracking-[0.2em]"
        >
        ...
        >
          TAHA <span className="text-primary italic">RESIDENCE</span>
        </h1>
